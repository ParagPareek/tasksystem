...
const OpenTask = ({   closeTask, taskId }) => {
  ...
  const handleDueDates = async (e) => {
    try {
      ...
      const response = await axios.post("http://localhost:3030/tasks/dueDate", {
        taskId,
  ...
  const handleStartDates = async (e) => {
    try {
      ...
      const response = await axios.post("http://localhost:3030/tasks/startDate", {
        taskId,
